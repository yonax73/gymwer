...
public class Aes {
 ...
 private final	int[] sBox =    {0x63,0x7c,0x77,0x7b,0xf2,0x6b,0x6f,0xc5,0x30,0x01,0x67,0x2b,0xfe,0xd7,0xab,0x76,
	...
	private final int[][] rCon =   { {0x00, 0x00, 0x00, 0x00},
						             {0x01, 0x00, 0x00, 0x00},
						             {0x02, 0x00, 0x00, 0x00},
						             {0x04, 0x00, 0x00, 0x00},
						             {0x08, 0x00, 0x00, 0x00},
	...
	public byte[] cipher(byte[] input,byte[][] w) {
		...
		byte[][] state = new byte[16][16];                 // initialise 4xNb byte-array 'state' with input [�3.4]
		
		for (int i = 0; i < 4*nb; i++) { state[i%4][(int) Math.floor(i/4)] = input[i];}
